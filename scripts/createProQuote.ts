...
await hubspotRequest("PUT", `/crm/v4/objects/line_items/${lineItemId}/associations/deal/${DEAL_ID}`, [
  {
...
const invoiceProperties = {
  hs_title: `Zendesk Suite Professional for ${AGENT_COUNT} Agents - Draft Invoice`,
...
try {
  await hubspotRequest("PUT", `/crm/v3/objects/quotes/${quoteId}/associations/line_item/${lineItemId}/quote_to_line_item`, {});
...
try {
  await hubspotRequest("PUT", `/crm/v3/objects/quotes/${quoteId}/associations/deal/${DEAL_ID}/quote_to_deal`, {});
